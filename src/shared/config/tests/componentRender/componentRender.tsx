...
export function TestProvider(props: TestProviderProps): JSX.Element {
    return (
        <MemoryRouter initialEntries={[props.options?.route ?? '/']}>
            <StoreProvider
                initialState={props.options?.initialState}
                asyncRedusers={props.options?.asyncReducers}>
...
export function ComponentRender(
    component: ReactNode,
    options: ComponentRenderProps = { route: '/' },
): RenderResult {
